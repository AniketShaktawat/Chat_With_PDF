...
def _codec_error_quote(e: UnicodeError) -> tuple[str, int]:
...
codecs.register_error("werkzeug.quote", _codec_error_quote)
...
def _make_unquote_part(name: str, chars: str) -> t.Callable[[str], str]:
    ...
    def _unquote_partial(value: str) -> str:
        ...
        for part in parts:
            out.append(unquote(part, "utf-8", "werkzeug.quote"))
